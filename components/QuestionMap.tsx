          ...
          return (
            <button
              ...
              className={`
                ...
                ${
                  isCurrent
                    ? "bg-blue-600 text-white shadow-lg shadow-blue-200 focus:ring-blue-400 ring-2 ring-blue-300 scale-110 z-10"
                    : isAnswered
                      ? "bg-green-50 text-green-700 border border-green-200 hover:bg-green-100 hover:border-green-300 focus:ring-green-400"
                      : "bg-gray-50 text-gray-500 border border-gray-150 hover:bg-white hover:border-gray-300 hover:text-gray-700 focus:ring-gray-400"
                }
              `}
            >
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
          <button
            ...
            disabled={page === 0}
            className="flex items-center gap-1 text-xs font-medium text-gray-500 hover:text-gray-700 disabled:opacity-30 disabled:cursor-not-allowed transition-colors cursor-pointer py-1"
